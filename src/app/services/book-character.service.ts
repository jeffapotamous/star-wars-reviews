      ...
      15: [
...

        {
          ...
          characters: [
            ...
            { name: 'Joss Adren', gender: Gender.M, species: '', description: 'Married to Pikka. Looked "like an engine block with a head stuck on top, with hair he kept cropped tight"' },
