...
export class CloneWarsEpisodesService {
  ...
  getCloneWarsEpisodesChronological(): CloneWarsEpisode[] {
    return this.listOfCloneWars.sort((a: CloneWarsEpisode, b: CloneWarsEpisode) => { return a.chronologicalOrder - b.chronologicalOrder });
  }
}
